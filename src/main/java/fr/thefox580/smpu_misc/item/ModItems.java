...
public class ModItems {
    ...
    public static final Item CERDU_PLUSH = registerItem("cerdu_plush", new Item(new FabricItemSettings()));
    ...
    private static Item registerItem(String name, Item item){
        return Registry.register(Registries.ITEM, new Identifier(SMPU_Misc_Fabric.MOD_ID, name), item);
    }

    public static void registerModItems(){
        SMPU_Misc_Fabric.LOGGER.info("Registering Mod Items for " + SMPU_Misc_Fabric.MOD_ID);
    }
}
